...
%User Line: %-----------------------------------------------------------------%
cada1td1 = sparse(Gator1Data.Index48,Gator1Data.Index49,statePlusEnd.dz0,129,645);
cada1td1 = D*cada1td1;
cada1td1 = cada1td1(:);
diffeqLHS.dz0 = full(cada1td1(Gator1Data.Index50));
...
cada1f1dz0 = cada1td1;
cada1f1 = tf.f - t0.f;
cada1tempdz0 = cada1f1dz0(Gator1Data.Index51);
cada1tf1 = diffeqRHS.f(Gator1Data.Index52);
cada1td1 = zeros(3200,1);
cada1td1(Gator1Data.Index53) = cada1tf1(:).*cada1tempdz0;
cada1td1(Gator1Data.Index54) = cada1td1(Gator1Data.Index54) + cada1f1.*diffeqRHS.dz0;
cada1f2dz0 = cada1td1;
cada1f2 = cada1f1*diffeqRHS.f;
cada1f3dz0 = cada1f2dz0./2;
cada1f3 = cada1f2/2;
cada1td1 = zeros(6272,1);
cada1td1(Gator1Data.Index55) = diffeqLHS.dz0;
cada1td1(Gator1Data.Index56) = cada1td1(Gator1Data.Index56) + -cada1f3dz0;
...
cada1td1(5633) = tf.dz0;
cada1td1(Gator1Data.Index57) = defects.dz0;
C.dz0 = cada1td1;
C.f = [tf.f;defects.f];
%User Line: C = [tf;defects];
C.dz0_size = [641,903];
C.dz0_location = Gator1Data.Index58;
end
